...
SAST_WEB_MAX_FILE_BYTES = int(os.environ.get("SAST_WEB_MAX_FILE_BYTES", str(25 * 1024 * 1024)))
SAST_WEB_MAX_FOLDER_BYTES = int(os.environ.get("SAST_WEB_MAX_FOLDER_BYTES", str(250 * 1024 * 1024)))
SAST_WEB_MAX_ZIP_BYTES = int(os.environ.get("SAST_WEB_MAX_ZIP_BYTES", str(100 * 1024 * 1024)))
SAST_WEB_MAX_ZIP_EXTRACTED_BYTES = int(os.environ.get("SAST_WEB_MAX_ZIP_EXTRACTED_BYTES", str(300 * 1024 * 1024)))
SAST_WEB_MAX_ZIP_FILES = int(os.environ.get("SAST_WEB_MAX_ZIP_FILES", "10000"))
